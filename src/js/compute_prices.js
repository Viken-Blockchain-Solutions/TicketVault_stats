...
async function getVaultStats() {
    ...
    // stakeholder data of each pool.
    holders13 = await getStakeholders(tv13);
    holders26 = await getStakeholders(tv26);
    holders52 = await getStakeholders(tv52);

    // amount of stakers on each pool.
    amount13 = holders13[2];
    amount26 = holders26[2];
    amount52 = holders52[2];
